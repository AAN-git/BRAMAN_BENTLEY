...
OWN = ['css/index6.css', 'css/inventory6.css', 'css/vehicle6.css', 'js/index6.js']
...
# 1. The SRP
write('inventory6.html', stamp6(lease_cards(blog(six(read('inventory.html'))))))
...
for f in pages:
    write('vehicles6/' + f, stamp6(carfax(lease_page(lease_cards(facts(blog(six(read('vehicles/' + f)))))))))
