...
| `index6.html` | **Direction 6 — the working copy of direction 5**, opened on 24 September 2026 so direction 5 stays as the client saw it. Its own `inventory6.html`, `vehicles6/`, `css/*6.css` and `js/index6.js`, mirrored from direction 4's by `tools/mirror6.py` (which `build.py` runs after `mirror5.py`) |
