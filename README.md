...
| `index6.html` | **Direction 6 — the day** (from 5, on the client's note of 24 September 2026: too dark for its place; words lost on photographs for an older clientele). `css/day6.css` loads last over direction 5's sheets on every direction-6 page and carries **four looks**, `?look=1..4` (the session keeps it; a switch in the corner): 1 White · 2 Satin Linen, words on the photographs re-solved; 3 White · 4 Satin Linen, words beside the photographs. Only the guideline's Digital Colour Use codes. No photograph under the words on the inventory and the car pages; 18px body; every text measured AA. Own `inventory6.html`, `vehicles6/`, mirrored by `tools/mirror6.py` |
| `dashboard6.html` | **The presentation of direction 6** — only its four looks: cover, one chapter per look with the live page on a screen and a phone, the index of the four links (`index6.html?look=1..4`); posters in `assets/present/d6-*.jpg` |
